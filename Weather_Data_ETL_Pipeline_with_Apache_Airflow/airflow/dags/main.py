...
api_key = "57d9d8979fe1964a24172d0da36db27a"
default_args = {
    'owner': 'airflow',
    'depends_on_past': False,
    'start_date': datetime(2024, 8, 10),
    'email': ['aba.issa88@gamil.com'],
...
def etl_weather_data():
    ...
    names_of_city = ["Chicago", "Seattle", "Kansas City", "Los Angeles", "London", "Las Vegas", "Beijing"]
...
with DAG('weather_dag',
    ...
    load_to_s3 = BashOperator(
        ...
        bash_command='aws s3 mv {{ ti.xcom_pull("tsk_extract_transform_weather_data") }} s3://airflow-weather-api-bucket',
    )

    slack_notification = SlackWebhookOperator(
        task_id="tsk_slack_notification",
        slack_webhook_conn_id="slack_conn_id",  
        message="This is just a test. Please chack the weather befor heading out.",
        channel="#weatherdata"
    )
